...
def basic_evaluate(board):
    """
    The original focused-evaluate function from the project.
    The original is kept because the projectproject expects the code in the project to be modified. 
    """
...
def minimax(board, depth, eval_fn = basic_evaluate,
    ...
    eval_fn -- (optional) the evaluation function to use to give a value to a leaf of the tree; see "focused_evaluate" in the project for an example
